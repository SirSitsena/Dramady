...
class PopularListAdapter(private val context: Context, private val dataSource: List<PopularNowMovie>) : BaseAdapter() {
    ...
    override fun getItem(position: Int): PopularNowMovie {
