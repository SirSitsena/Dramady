        ...
        if(titleId != null){
            viewModelScope.launch(Dispatchers.IO){
                ...
                MovieRoomDatabase.getFavouritedMoviesDao()?.insert(
                    FavoritedMovies(titleId, movie.getRank(), movie.getTitle(), movie.getFullTitle(), movie.getYear(), movie.getImage(), movie.getReleaseDate(), movie.getRuntimeMins(), movie.getRuntimeStr(), movie.getPlot(),
