...
class AllTimeBestListAdapter(private val context: Context, private val dataSource: List<AllTimeBestMovie>) : BaseAdapter() {
    ...
    override fun getItem(position: Int): AllTimeBestMovie {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        imdbRatingTextView.text = "(${movie.imDbRating}/10)"
