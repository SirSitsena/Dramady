...
class FavouriteListAdapter(private val context: Context, private val dataSource: List<FavouritedMovies>) : BaseAdapter() {
    ...
    override fun getItem(position: Int): FavouritedMovies {
