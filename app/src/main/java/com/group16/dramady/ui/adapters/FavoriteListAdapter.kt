...
class FavoriteListAdapter(private val context: Context, private val dataSource: List<FavoritedMovie>) : BaseAdapter() {
    ...
    override fun getItem(position: Int): FavoritedMovie {
