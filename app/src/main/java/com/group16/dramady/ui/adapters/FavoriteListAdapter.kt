...
class FavoriteListAdapter(private val context: Context, private val dataSource: List<FavoritedMovies>) : BaseAdapter() {
    ...
    override fun getItem(position: Int): FavoritedMovies {
